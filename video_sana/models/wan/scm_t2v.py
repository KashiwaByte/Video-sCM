    ...
    def generate(self,
        ...
        Args:
            ...
            sigma_data (`float`, *optional*, defaults to 0.5):
                Standard deviation of noise added to the input video frames.
            intermediate_timesteps (`int`, *optional*, defaults to None):
                Number of intermediate timesteps for SCM scheduler.
